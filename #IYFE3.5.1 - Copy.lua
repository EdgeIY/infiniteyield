...
Toggles.CanvasSize = UDim2.new(0, 0, 0, 170)
...
Swim.Position = UDim2.new(0, 0, 0, 125)
...
Fling.Position = UDim2.new(0, 0, 0, 150)
...
function CreateLabel(Name, Text)
	...
	local size2 = scrollCL.CanvasSize.Y.Offset
...
CMDs[#CMDs + 1] = {NAME = 'nopurchasepromts / nopromts', DESC = 'Prevents the game from showing you purchase promts'}
...
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'setwaypoint / spos [name]', DESC = 'Sets a waypoint at your position'}
CMDs[#CMDs + 1] = {NAME = 'setwaypointpos [name] [X Y Z]', DESC = 'Sets a waypoint with specified coordinates'}
CMDs[#CMDs + 1] = {NAME = 'deletewaypoint / dpos [name]', DESC = 'Deletes a waypoint'}
CMDs[#CMDs + 1] = {NAME = 'waypoint / lpos [name]', DESC = 'Teleports player to a waypoint'}
CMDs[#CMDs + 1] = {NAME = 'clearwaypoints / clearpos / cpos', DESC = 'Clears all waypoints'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
...
CMDs[#CMDs + 1] = {NAME = 'clickdel', DESC = 'Go to settings>Keybinds>Add for clickdel'}
...
addcmd('clickdel', {},
	...
	if deleting then
		notify("Click Delete", "Click Delete Enabled")
	else
		notify("Click Delete", "Click Delete Disabled")
	end
end)
...
addcmd('nopurchasepromts',{'nopromts'},
	function(args, speaker)
...
addcmd('headsit',{},
	...
	for i,v in pairs(players)do
		...
		headSit = game:GetService("RunService").RenderStepped:Connect(function()
			if Players[v].Character and Players[v].Character:FindFirstChild('HumanoidRootPart') and speaker.Character:FindFirstChild('HumanoidRootPart') then
...
addcmd('vr',{},
	...
	loadstring(game:HttpGet('https://ghostbin.co/paste/8xw4a/raw'))()
end)
...
addcmd('tpunanchored',{'tpua'},
	...
	for i,v in pairs(players) do
		local Forces = {}
		for _,part in pairs(workspace:GetDescendants()) do
			if Players[v].Character:FindFirstChild('Head') and part:IsA("BasePart" or "UnionOperation" or "Model") and part.Anchored == false and part:IsDescendantOf(game.Players.LocalPlayer.Character) == false and part.Name == "Torso" == false and part.Name == "Head" == false and part.Name == "Right Arm" == false and part.Name == "Left Arm" == false and part.Name == "Right Leg" == false and part.Name == "Left Leg" == false and part.Name == "HumanoidRootPart" == false then
				if part:FindFirstChildOfClass("BodyPosition") then part.BodyPosition:Destroy() end
